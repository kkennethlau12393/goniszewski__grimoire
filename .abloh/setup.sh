...
# step 1: dependencies, from your lockfile. From package-lock.json; chosen over bun.lock and bun.lockb, neither a packageManager field nor your CI says which, so the older ecosystem is assumed - declare "packageManager": "bun@<version>", or pass --install-command, to install with bun
